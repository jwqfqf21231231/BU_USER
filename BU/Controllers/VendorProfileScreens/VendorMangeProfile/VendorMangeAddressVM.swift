...
import Foundation
import UIKit
class VendorMangeAddressVM: DataStoreStructListModeling {
    
    internal var validationMethodManager:ValidationProtocol?
    //TODO: Singleton object
    static let shared = VendorMangeAddressVM()
    private init() {}
...
extension VendorMangeAddressVM:StateCityDepnendencyInjection{
