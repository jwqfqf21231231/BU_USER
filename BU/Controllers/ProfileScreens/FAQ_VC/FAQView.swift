...
public class FAQView: UIView {
  ...
  public init(frame: CGRect,title: String = String(), items: [FAQItem]) {
    self.items = items
  ...
  private func addConstraintsForTableViewAndTitleLabel() {
    let titleLabelTrailing = NSLayoutConstraint(item: titleLabel ?? UILabel(), attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailingMargin, multiplier: 1, constant: 0)
    let titleLabelLeading = NSLayoutConstraint(item: titleLabel  ?? UILabel(), attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leadingMargin, multiplier: 1, constant: 0)
    let titleLabelTop = NSLayoutConstraint(item: titleLabel  ?? UILabel(), attribute: .top, relatedBy: .equal, toItem: self, attribute: .topMargin, multiplier: 1, constant: 00)

    let tableViewTrailing = NSLayoutConstraint(item: tableView ?? UITableView(), attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailingMargin, multiplier: 1, constant: 0)
    let tableViewLeading = NSLayoutConstraint(item: tableView ?? UITableView(), attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leadingMargin, multiplier: 1, constant: 0)
    let tableViewTop = NSLayoutConstraint(item: tableView ?? UITableView(), attribute: .top, relatedBy: .equal, toItem: titleLabel, attribute: .bottom, multiplier: 1, constant: 0)
    let tableViewBottom = NSLayoutConstraint(item: tableView ?? UITableView(), attribute: .bottom, relatedBy: .equal, toItem: self, attribute: .bottomMargin, multiplier: 1, constant: 0)
  ...
  required public init?(coder aDecoder: NSCoder) {
    ...
    @objc func handleQuestionLabelTap(_ sender: UITapGestureRecognizer) {
...
public class FAQConfiguration {
  ...
  func defaultValue() {
    ...
    self.questionTextFont = AppFont.Bold.size(AppFontName.Montserrat, size: 16)
    self.answerTextFont = AppFont.Regular.size(AppFontName.Montserrat, size: 12)
    self.titleTextColor = UIColor.black
    self.titleTextFont = AppFont.Bold.size(AppFontName.Montserrat, size: 20)
    self.titleLabelBackgroundColor = UIColor.clear
    self.viewBackgroundColor =  AppColor.whiteColor
    self.cellBackgroundColor = UIColor.white
    self.separatorColor = AppColor.whiteColor
  }
}
